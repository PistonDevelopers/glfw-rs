...
window_callback!(fn mouse_button_callback(button: c_int, action: c_int, mods: c_int)        => mouse_button_fun(cast::transmute(button as int), cast::transmute(action as int), Modifiers(mods)))
...
window_callback!(fn key_callback(key: c_int, scancode: c_int, action: c_int, mods: c_int)   => key_fun(cast::transmute(key as int), scancode, cast::transmute(action as int), Modifiers(mods)))
